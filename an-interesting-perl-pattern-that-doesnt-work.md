...
If you already understand blocks and closures, then you may want to skip their explanations and go straight to an explanation of the actual problem [here](#The-Problem).
